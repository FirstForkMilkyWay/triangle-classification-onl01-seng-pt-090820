class Triangle
  ...
  def kind 
    ...
    if @side1>0 && @side2>0 && @side3>0 && @side1 + @side2 > @side3 && @side1 != @side2 && @side1 != @side3 && @side2 != @side3
        return :scalene 
    elsif @side1>0 && @side2>0 && @side3>0 && @side1 + @side2 > @side3 && @side1 == @side2 && @side1 != @side3 && @side2 != @side3 || @side1>0 && @side2>0 && @side3>0 && @side1 + @side2 > @side3 && @side1 =! @side2 && @side1 != @side3 && @side2 == @side3   
        return :isosceles 
